...
class ColdStartDataBuilder_Artist(object):
    def __init__(
        self,
        training_data,
        warm_valid_data,
        ...
        super(ColdStartDataBuilder_Artist, self).__init__()
        ...
        self.track_artist_map = item_artist_map
        ...
        warm_item_set = set(warm_item_idx)
        for i, artist in enumerate(item_artist_map):
            if i in warm_item_set:
                self.artist_track_map[artist].add(i)
